...
const ProductShellHide = () => import('../views/ProductShellHide.vue')
const DocumentPage = () => import('../views/ApiDocumentPage.vue')
    ...
    routes: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            // All child routes have the current Service injected in the `product` prop.
            path: '/',
            component: ProductShellHide,
            children: [
              {
                path: '/presentation/:product/:slug*',
